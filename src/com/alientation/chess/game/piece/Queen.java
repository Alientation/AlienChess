...
public class Queen extends Piece{
	...
	public Queen(Team team, GridSlot slot, String IMAGE_PATH) {
		super(team, slot, IMAGE_PATH);
	}

	@Override
	public ArrayList<Move> getLegalMoves(Board b, boolean isPseudo) {
		return PossibleMoveGenerator.getLegalQueenMoves(b, this, isPseudo);
	}
	...
	public Move getMoveTo(GridSlot slot, boolean isPseudo) {
		...
		//Optimized checks
		if (!this.location.isOnSameDiagonal(slot) && !this.location.isOnSameAxis(slot)) {
			return null;
		}
